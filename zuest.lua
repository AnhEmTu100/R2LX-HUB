...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    _G.FastAttackR2LX HUBYTB_Mode = Value
	if _G.FastAttackR2LX HUBYTB_Mode == "Fast Attack" then
		_G.Fast_Delay = 0.12
	elseif _G.FastAttackR2LX HUBYTB_Mode == "Normal Attack" then
		_G.Fast_Delay = 0.2
	elseif _G.FastAttackR2LX HUBYTB_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0.05
	end
end)
...
ToggleFastAttack:OnChanged(function(Value)
 _G.FastAttackR2LX HUBYTB = Value
end)
...
while wait() do
    pcall(function()
        if _G.FastAttackR2LX HUBYTB then
            repeat wait(_G.DelayAttackPlayer)
               AttackNoCoolDown()
            until not _G.FastAttackR2LX HUBYTB
        end
    end)
end
end)
